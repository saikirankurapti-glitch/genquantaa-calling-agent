/**
 * GenQuantaa Calling Agent Widget
 * Embeddable voice & chat widget for GenQuantaa agents
 * Version: 1.1.0
 */
...
(function() {
  ...
  async function initializeWidget() {
    ...
    const script = document.currentScript || document.querySelector('script[src*="genquantaa-widget.js"]') || document.querySelector('script[src*="dograh-widget.js"]');
    if (!script) {
      console.error('GenQuantaa Widget: Script not found');
      return;
    }
  ...
  window.GenQuantaaWidget = window.GenQuantaaWidget || publicApi;
  window.DograhWidget = window.DograhWidget || window.GenQuantaaWidget;
