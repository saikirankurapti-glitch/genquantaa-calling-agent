...
export async function impersonateAsSuperadmin(params: {
  ...
  // (served from the target sub-domain, e.g. app.genquantaa.com). The route will set the
  ...
  // via NEXT_PUBLIC_APP_URL (e.g. https://app.genquantaa.com); falls back to the current
